      ...
      <Row gutter={16}>
        <Col xs={24} sm={12} md={6}>
          <div className="gutter-row">
            ...
            <p><Icon icon="teenyicons:up-solid" color="#26a65b" width={10} height={10} /> 5% from last month</p>
          </div>
        </Col>
        <Col xs={24} sm={12} md={6}>
          <div className="gutter-row">
            ...
            <p><Icon icon="teenyicons:down-solid" color="#ef4836" width="10" height="10" /> 20% from last month</p>
          </div>
        </Col>
        <Col xs={24} sm={12} md={6}>
          <div className="gutter-row">
            ...
            <p><Icon icon="teenyicons:up-solid" color="#26a65b" width={10} height={10} /> 2% from last month</p>
          </div>
        </Col>
        <Col xs={24} sm={12} md={6}>
          <div className="gutter-row">
            ...
            <p><Icon icon="teenyicons:down-solid" color="#ef4836" width="10" height="10" /> 10% from last month</p>
          </div>
        </Col>
      </Row>
      <h1>Calendar</h1>
